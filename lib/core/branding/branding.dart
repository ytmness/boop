...
class Branding {
  ...
  static const Color primaryPurple =
      Color(0xFF8E5AFF); // Morado principal del logo
  ...
  static const Color darkBackground =
      Color(0xFF080C32); // Fondo oscuro azul profundo

  // Colores de fondo con efecto glass
  static const Color glassBackgroundLight =
      Color(0x40FFFFFF); // Blanco semi-transparente (menos opaco)
  static const Color glassBackgroundDark =
      Color(0x40080C32); // Azul oscuro semi-transparente
  ...
  static const String fontFamilyDisplay =
      '.SF Pro Display'; // Para títulos grandes
  static const String fontFamilyText = '.SF Pro Text'; // Para texto normal
  static const String fontFamilyRounded =
      '.SF Pro Rounded'; // Para elementos redondeados
  ...
  static const double radiusRound =
      999.0; // Para elementos completamente redondeados
