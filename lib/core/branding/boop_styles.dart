...
class BoopStyles {
  ...
  static const Color darkBackground = Color(0xFF1B1029);
  static const Color darkBackgroundAlt = Color(0xFF2A1F3D);
  ...
  /// Degradado de fondo blanco para glass panels
  ...
  /// Fondo principal morado oscuro degradado
  ...
  static TextStyle boopHeadline({double fontSize = 17, Color? color}) => TextStyle(
    fontSize: fontSize,
